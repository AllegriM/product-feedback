...
function EditFeedBack() {
  const feedbackTitle = 'A task to be edited';
  return (
    <div className="p-6 mt-2">
      <div className="bg-white relative rounded-lg text-darkBlueXs p-6 text-left">
        ...
        <form action="">
          ...
          <p className="text-lightGray tracking-tight text-sm">Change feature state</p>
          <input className="bg-slate-100 w-full rounded-md mt-3 mb-5 p-3" type="" />
          <label className="font-bold" htmlFor="">
            Feedback Detail
          </label>
          ...
          <div className="flex flex-col gap-3 mt-5">
            ...
            <Button text={'Delete'} color={'red-500'} icon={false} />
          </div>
        </form>
      </div>
    </div>
